...
export const Fd = ({calculations,cmsData,rightNavBar}) => {
...
return (
    ...
    <h1 className="font24 mb40 text2828 bottomborderf5a623 Innerheading fontMedium lineHeight36 minHeight72">FD Calculator</h1>
    ...
    <FdCalculator calculations={calculations } />
    { cmsData.length>0 &&
      <>
