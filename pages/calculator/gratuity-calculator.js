import { Gratuity } from "../../components/calculator/GratuityCalculator";
import GratuityCalculation from '../../data/GratuityCalculation.json'
import { getGeneralContent } from "../../services/blogs";
import { MetaHead, SchemaHead } from "../../components/shared";

const GratuityCalculator = ({ cmsData, genericUrl, rightNavBar }) => {
  ...
  return (
    <>
      ...
      <Gratuity calculations={GratuityCalculation} cmsData={cmsData} rightNavBar={rightNavBar} />
    </>
  );
}
export async function getServerSideProps() {
  let genericUrl = 'calculator/gratuity-calculator';
