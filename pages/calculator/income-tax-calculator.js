...
const IncomeTaxCalculator = ({ cmsData, genericUrl,  rightNavBar }) => {
  ...
  return (
    <>
      ...
      <IncomeTaxCalc cmsData={cmsData} rightNavBar={rightNavBar} />
    </>
  );
}
export async function getServerSideProps() {
    let genericUrl = 'calculator/income-tax-calculator';
