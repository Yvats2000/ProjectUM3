...
import { SukanyaYojanaCalculator } from "../../components/calculator/SukanyaSamriddhiYojanaCalculator";

const SukanyaSamriddhiYojanaCalculator = ({ cmsData, genericUrl, rightNavBar }) => {
  ...
  return (
    <>
      ...
      <SukanyaYojanaCalculator cmsData={cmsData} rightNavBar={rightNavBar} />
    </>
  );
}
export async function getServerSideProps() {
  let genericUrl = 'calculator/sukanya-samriddhi-yojana-calculator';
