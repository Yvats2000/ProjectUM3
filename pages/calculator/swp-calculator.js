import { Swp } from '../../components/calculator';
import { getGeneralContent } from "../../services/blogs";
import { MetaHead, SchemaHead } from "../../components/shared";

const SwpCalculator = ({ cmsData, genericUrl, rightNavBar }) => {
  ...
  return (
    <>
      ...
      <Swp cmsData={cmsData} rightNavBar={rightNavBar} />
    </>
  );
}
export async function getServerSideProps() {
  let genericUrl = 'calculator/swp-calculator';
