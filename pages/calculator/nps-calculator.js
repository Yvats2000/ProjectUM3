import { Nps } from '../../components/calculator';
import { getGeneralContent } from "../../services/blogs";
import { MetaHead, SchemaHead } from "../../components/shared";

const NpsCalculator = ({ cmsData, genericUrl, rightNavBar }) => {
  ...
  return (
    <>
      ...
      <Nps cmsData={cmsData} rightNavBar={rightNavBar} />
    </>
  );
}
export async function getServerSideProps() {
  let genericUrl = 'calculator/nps-calculator';
