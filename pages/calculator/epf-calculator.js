import { Epf } from '../../components/calculator';
import { getGeneralContent } from "../../services/blogs";
import { MetaHead, SchemaHead } from "../../components/shared";

const EpfCalculator = ({ cmsData, genericUrl, rightNavBar }) => {
  ...
  return (
    <>
      ...
      <Epf cmsData={cmsData} rightNavBar={rightNavBar} />
    </>
  );
}
export async function getServerSideProps() {
  let genericUrl = 'calculator/epf-calculator';
